...
export class GroupGuard extends BaseGuard {
    ...
    override activateHelper(state?: RouterStateSnapshot, route?: ActivatedRouteSnapshot): Observable<boolean | UrlTree> {
        ...
        return result.pipe(
            ...
            console.log('Activate Account --- > ', activeAccount);
            ...
            console.log('Activate Account second--- > ', activeAccount);
            ...
            console.log('Activate Account Groups --- > ', activeAccount?.idTokenClaims?.groups);
